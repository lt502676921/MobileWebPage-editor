...
describe("UserProfile component", () => {
  ...
  test("should render the correct interface", () => {
    // <div><input /></div>
    // <ul class="picked-color-list">
    // <li class="item0" or class="transparent-back">
    // <div></div>
    // </li></ul>
  ...
  test("should send the correct event when change input", async () => {
  ...
  test("should send the correct event when clicking the color list", async () => {
